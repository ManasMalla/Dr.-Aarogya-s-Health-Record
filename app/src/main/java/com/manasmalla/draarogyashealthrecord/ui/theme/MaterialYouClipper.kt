...
fun drawMaterialYouClipper(size: Size): Path {
    ...
    val _xScaling:Float = size.width / 405
    val _yScaling:Float = size.height / 402
    path.lineTo(168 * _xScaling, (1.33 * _yScaling).toFloat())
    dCubicTo(path=path,
        165.52 * _xScaling,
        1.99 * _yScaling,
        162.31 * _xScaling,
...
private fun dCubicTo(path: Path, x1: Any, y1: Any, x2: Any, y2: Any, x3: Any, y3: Any) {
